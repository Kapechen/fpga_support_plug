...
export function getOpeParam(currentDirName, opeParam) {
    // 获取当前平台运行的系统
...
export function getPropertyInfo(opeParam) {
...
export function generatePropertyFile(opeParam) {
    if (opeParam.propertyPath == "") {
        opeParam.propertyPath = `${opeParam.workspacePath}/.vscode/property.json`;
...
export function getPrjFiles(opeParam, HDLFileList) {
...
export function refreshPrjFolder(opeParam) {
    if (opeParam.prjInfo !== null) {
...
export function refreshPrjInfo(opeParam) {
    if (opeParam.prjInfo !== null) {
...
export function addDevice(opeParam) {
...
export function delDevice(opeParam) {
    let propertyParam = files.pullJsonInfo(`${opeParam.rootPath}/../property.json`);
...
export function overwriteInitProperty(opeParam) {
