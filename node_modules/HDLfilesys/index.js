...
function registerPrjsServer(context, opeParam){
    ...
    context.subscriptions.push(vscode.commands.registerCommand('TOOL.Overwrite_InitProperty', () => {
        prjs.overwriteInitProperty(opeParam);
    }));
